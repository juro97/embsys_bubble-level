\hypertarget{nucleo-l432kc__9dof-imu-click_2_drivers_2_s_t_m32_l4xx___h_a_l___driver_2_inc_2stm32l4xx__hal__tim_8h_source}{}\doxysection{stm32l4xx\+\_\+hal\+\_\+tim.\+h}
\label{nucleo-l432kc__9dof-imu-click_2_drivers_2_s_t_m32_l4xx___h_a_l___driver_2_inc_2stm32l4xx__hal__tim_8h_source}\index{nucleo-\/l432kc\_9dof-\/imu-\/click/Drivers/STM32L4xx\_HAL\_Driver/Inc/stm32l4xx\_hal\_tim.h@{nucleo-\/l432kc\_9dof-\/imu-\/click/Drivers/STM32L4xx\_HAL\_Driver/Inc/stm32l4xx\_hal\_tim.h}}
\mbox{\hyperlink{nucleo-l432kc__9dof-imu-click_2_drivers_2_s_t_m32_l4xx___h_a_l___driver_2_inc_2stm32l4xx__hal__tim_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
\DoxyCodeLine{1 }
...
\DoxyCodeLine{47 \{}
\DoxyCodeLine{48   uint32\_t Prescaler;         }
\DoxyCodeLine{51   uint32\_t CounterMode;       }
\DoxyCodeLine{54   uint32\_t Period;            }
\DoxyCodeLine{58   uint32\_t ClockDivision;     }
\DoxyCodeLine{61   uint32\_t RepetitionCounter;  }
\DoxyCodeLine{72   uint32\_t AutoReloadPreload;  }
...
\DoxyCodeLine{80 \{}
\DoxyCodeLine{81   uint32\_t OCMode;        }
\DoxyCodeLine{84   uint32\_t Pulse;         }
\DoxyCodeLine{87   uint32\_t OCPolarity;    }
\DoxyCodeLine{90   uint32\_t OCNPolarity;   }
\DoxyCodeLine{94   uint32\_t OCFastMode;    }
\DoxyCodeLine{99   uint32\_t OCIdleState;   }
\DoxyCodeLine{103   uint32\_t OCNIdleState;  }
...
\DoxyCodeLine{112 \{}
\DoxyCodeLine{113   uint32\_t OCMode;        }
\DoxyCodeLine{116   uint32\_t Pulse;         }
\DoxyCodeLine{119   uint32\_t OCPolarity;    }
\DoxyCodeLine{122   uint32\_t OCNPolarity;   }
\DoxyCodeLine{126   uint32\_t OCIdleState;   }
\DoxyCodeLine{130   uint32\_t OCNIdleState;  }
\DoxyCodeLine{134   uint32\_t ICPolarity;    }
\DoxyCodeLine{137   uint32\_t ICSelection;   }
\DoxyCodeLine{140   uint32\_t ICFilter;      }
...
\DoxyCodeLine{148 \{}
\DoxyCodeLine{149   uint32\_t  ICPolarity;  }
\DoxyCodeLine{152   uint32\_t ICSelection;  }
\DoxyCodeLine{155   uint32\_t ICPrescaler;  }
\DoxyCodeLine{158   uint32\_t ICFilter;     }
...
\DoxyCodeLine{166 \{}
\DoxyCodeLine{167   uint32\_t EncoderMode;   }
\DoxyCodeLine{170   uint32\_t IC1Polarity;   }
\DoxyCodeLine{173   uint32\_t IC1Selection;  }
\DoxyCodeLine{176   uint32\_t IC1Prescaler;  }
\DoxyCodeLine{179   uint32\_t IC1Filter;     }
\DoxyCodeLine{182   uint32\_t IC2Polarity;   }
\DoxyCodeLine{185   uint32\_t IC2Selection;  }
\DoxyCodeLine{188   uint32\_t IC2Prescaler;  }
\DoxyCodeLine{191   uint32\_t IC2Filter;     }
...
\DoxyCodeLine{199 \{}
\DoxyCodeLine{200   uint32\_t ClockSource;     }
\DoxyCodeLine{202   uint32\_t ClockPolarity;   }
\DoxyCodeLine{204   uint32\_t ClockPrescaler;  }
\DoxyCodeLine{206   uint32\_t ClockFilter;     }
...
\DoxyCodeLine{214 \{}
\DoxyCodeLine{215   uint32\_t ClearInputState;      }
\DoxyCodeLine{217   uint32\_t ClearInputSource;     }
\DoxyCodeLine{219   uint32\_t ClearInputPolarity;   }
\DoxyCodeLine{221   uint32\_t ClearInputPrescaler;  }
\DoxyCodeLine{224   uint32\_t ClearInputFilter;     }
...
\DoxyCodeLine{234 \{}
\DoxyCodeLine{235   uint32\_t  MasterOutputTrigger;   }
\DoxyCodeLine{237   uint32\_t  MasterOutputTrigger2;  }
\DoxyCodeLine{239   uint32\_t  MasterSlaveMode;       }
...
\DoxyCodeLine{252 \{}
\DoxyCodeLine{253   uint32\_t  SlaveMode;         }
\DoxyCodeLine{255   uint32\_t  InputTrigger;      }
\DoxyCodeLine{257   uint32\_t  TriggerPolarity;   }
\DoxyCodeLine{259   uint32\_t  TriggerPrescaler;  }
\DoxyCodeLine{261   uint32\_t  TriggerFilter;     }
...
\DoxyCodeLine{272 \{}
\DoxyCodeLine{273   uint32\_t OffStateRunMode;      }
\DoxyCodeLine{275   uint32\_t OffStateIDLEMode;     }
\DoxyCodeLine{277   uint32\_t LockLevel;            }
\DoxyCodeLine{279   uint32\_t DeadTime;             }
\DoxyCodeLine{281   uint32\_t BreakState;           }
\DoxyCodeLine{283   uint32\_t BreakPolarity;        }
\DoxyCodeLine{285   uint32\_t BreakFilter;          }
\DoxyCodeLine{287   uint32\_t Break2State;          }
\DoxyCodeLine{289   uint32\_t Break2Polarity;       }
\DoxyCodeLine{291   uint32\_t Break2Filter;         }
\DoxyCodeLine{293   uint32\_t AutomaticOutput;      }
...
\DoxyCodeLine{351 \{}
\DoxyCodeLine{352   \mbox{\hyperlink{struct_t_i_m___type_def}{TIM\_TypeDef}}                        *Instance;         }
\DoxyCodeLine{353   \mbox{\hyperlink{struct_t_i_m___base___init_type_def}{TIM\_Base\_InitTypeDef}}               Init;              }
\DoxyCodeLine{354   \mbox{\hyperlink{group___t_i_m___exported___types_gaa3fa7bcbb4707f1151ccfc90a8cf9706}{HAL\_TIM\_ActiveChannel}}              Channel;           }
\DoxyCodeLine{355   \mbox{\hyperlink{struct_____d_m_a___handle_type_def}{DMA\_HandleTypeDef}}                  *hdma[7];          }
\DoxyCodeLine{357   \mbox{\hyperlink{nucleo-l432c__piezo-beeper_2_switch_buzz_2_drivers_2_s_t_m32_l4xx___h_a_l___driver_2_inc_2stm32l4xx__hal__def_8h_ab367482e943333a1299294eadaad284b}{HAL\_LockTypeDef}}                    Lock;              }
\DoxyCodeLine{358   \mbox{\hyperlink{nucleo-l432c__piezo-beeper_2_switch_buzz_2_drivers_2_c_m_s_i_s_2_include_2core__armv81mml_8h_aec43007d9998a0a0e01faede4133d6be}{\_\_IO}} \mbox{\hyperlink{group___t_i_m___exported___types_gae0994cf5970e56ca4903e9151f40010c}{HAL\_TIM\_StateTypeDef}}          State;             }
...
\DoxyCodeLine{361   \mbox{\hyperlink{nucleo-l432c__piezo-beeper_2_switch_buzz_2_drivers_2_c_m_s_i_s_2_include_2core__armv81mml_8h_aec43007d9998a0a0e01faede4133d6be}{\_\_IO}} \mbox{\hyperlink{group___t_i_m___exported___types_ga9b87df539778a60ea940a9d5ba793f7c}{HAL\_TIM\_DMABurstStateTypeDef}}  DMABurstState;     }
