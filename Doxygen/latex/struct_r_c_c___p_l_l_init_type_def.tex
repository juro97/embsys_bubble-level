...
PLLM\+: Division factor for PLL VCO input clock. This parameter must be a number between Min\+\_\+\+Data = 1 and Max\+\_\+\+Data = 16 on STM32\+L4\+Rx/\+STM32\+L4\+Sx devices. This parameter must be a number between Min\+\_\+\+Data = 1 and Max\+\_\+\+Data = 8 on the other devices \mbox{\Hypertarget{struct_r_c_c___p_l_l_init_type_def_a2e8a73f7961f8d6570193c68daba88a6}\label{struct_r_c_c___p_l_l_init_type_def_a2e8a73f7961f8d6570193c68daba88a6}} 
...
PLLQ\+: Division factor for SDMMC1, RNG and USB clocks. This parameter must be a value of \mbox{\hyperlink{group___r_c_c___p_l_l_q___clock___divider}{PLLQ Clock Divider}} ~\newline
...
PLLR\+: Division for the main system clock. User have to set the PLLR parameter correctly to not exceed max frequency 120MHZ on STM32\+L4\+Rx/\+STM32\+L4\+Sx devices else 80MHz on the other devices. This parameter must be a value of \mbox{\hyperlink{group___r_c_c___p_l_l_r___clock___divider}{PLLR Clock Divider}} ~\newline
